...
export default function MainContent(props) {
  ...
  const s =
    "Not just a coding platform, but a complete placement ecosystem with strong  emphasis on high quality placement training & support, not only equipping  you with relevant job market skills but providing every help to land your  dream job.";
          ...
          <Box>
            <Typography
              ...
              sx={{
                ...
                fontSize: props.size
                  ? { xs: "2.5rem", sm: "3.5rem", md: "6rem" }
                  : { xs: "2.5rem", sm: "4rem", md: "6rem" },
              }}
            >
              ...
              >
                ...
                >
                  <button className="btn-giveTest btn-giveTest-responsive">
                    {props.name.programName === "PlaceKit" ? "Enroll" : "Apply"}
                  </button>{" "}
                </HashLink>
              </Box>
            ) : null}
